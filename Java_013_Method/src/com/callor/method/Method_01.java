...
public class Method_01 {
	...
	public static void main(String[] args) {
		 ...
		 * Scanner() 생성자는 객체를 생성할 때 System.in(키보드 입력 장치)를 연결할 수 있도록
		 * 			매개변수에 정보를 전달해주어야 한다.
		 */
		...
		/*
		 * int 형변수와 Integer wrapper를 사용하여 만든 변수
		 * 사용하는 기본방법은 동일하다.
		...
		/*
		 * 어떤 수가 짝수인가를 조건검사하고 짝수이면 짝수이다 라고 표현하고
		 * 		else이면 홀수이다 라고 표현할 수 있지만
