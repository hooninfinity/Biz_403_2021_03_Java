...
public class NumberServiceV1 {
	 ...
	 * 
	 * 이 메서드는 정수형 3의 배수 또는 null 값을 return 해야 하기 때문에
	 * 		Integer 형 return type을 설정해야 한다
	 * 		void 대신 Integer를 사용한다
	 * 
	 * void 대신 Integer를 사용하면 반드시 return 명령문과
	 * 		return 할 값(대상)이 코드에 있어야 한다
	 * 		아직 method에 return 문이 없기 때문에 오류가 발생
	 * 
	 * method에 오류가 나는 것을 없애기 위해 return문을 추가한다
	 * 이 method는 return 명령문만으로 처리가 되지 않고 반드시 return 할 값(대상)이 있어야 한다
	 * 
	 * primitive type중에 숫자인 경우는 0을
	...
	public Integer inputNum() {
		...
		if (num2 % 3 == 0) {
			 ...
			 * 		int 형을 Integer wrapper 클래스 형으로 변환하는 과정이 일어난다 
			 */
			return num2;
		}
		return null;
