...
public class Variable_10 {
	...
	public static void main(String[] args) {
		...
		// intNum1을 1증가하고 == 1이된다
		// intNum1에 저장된 1을 더하여 intSum에 저장하라
		// intSum = 0 + 1
		...
		intSum += ++intNum; // 6 + 4을 intSum저장
		
		
		intNum = 1;
		intSum = 0;
		
		// 처음에 만들어진 intNum값(1)을 intSum 변수에 누적하고
		// 다음줄 코드를 위하여 intNum을 1 증가시켜라
		intSum += intNum++; // 0 + 1, 이후 intNum == 2
		intSum += intNum++; // 1 + 2
