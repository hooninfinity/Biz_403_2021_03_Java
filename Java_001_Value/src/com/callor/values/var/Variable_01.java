...
public class Variable_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 3. 어딘가에 보관된 30을 CPU의 연산장치로 이동(CPU의 controller가 하는일)
		 ...
		 * 9. println() 덧셈결과가 보관된 기억장소를 찾아가서 보관된 값을 가져와서
		 * 		System.out에게 보낸다.
		 * 10. System.out은 운영체제(윈도우)에게 결과를 Console(cmd 창)에 출력해달라고 요청
		 ...
		 * 기억장치 어딘가에 (임시로)보관이 되어 연산수행이 이루어진다.
		 * 
		 * 그런데,
		 * 똑같은 30이라는 숫자가 5번 사용되었지만 이 30은 5개의 기억장소를 사용한다.
		 ...
		 * 연산할 때 그 값을 참조하여 연산을 하도록 한다면 기억장치를 효율적으로 사용할 수 있다.
		 * 
		 * 이러한 개념을 발전시킨 것을 "변수(Variable)"라고 한다.
		 */
