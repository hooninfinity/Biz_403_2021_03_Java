...
//				return;
	...
	/*
	 * 현재 클래스 내부에서만 호출되는 method private로선언한다.
	...
	protected String inputNum() {
		...
		// 다시 메뉴로 돌아간다(selectMenu에서 inputScore를 호출했으므로)
		if (intNum == null) { // 탈출통로
			return null;
		}
...
//				return null;
				break;
			} else if (strName.equals("")) { // 입력없이 Enter만 입력했을 경우
	...
	public void printScore() {
		...
		for(int index = 0 ; index < scoreList.size() ; index++) {
			...
			// System.out.println(scoreList.get(getNum));
