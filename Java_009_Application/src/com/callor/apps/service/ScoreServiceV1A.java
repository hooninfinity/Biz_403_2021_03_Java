...
public class ScoreServiceV1A {
	...
	// 클래스를 사용하여 객체를 "선언만" 한 경우 아직 사용할 준비가 되어있지 않다
	...
	public void makeScores() {
		// 무한 반복문을 사용하여
		// 국어점수가 0 ~ 100 범위를 벗어나면 메시지를 보여주고 다시 점수를 입력받도록 한다
		// 만약 정상적인 범위를 입력하면 반복문을 종료하고, 다음 코드가 실행되도록 한다
		while(true) {
	...
	// method를 호출하여 명령을 실행할 수 있도록 하는 keyword
