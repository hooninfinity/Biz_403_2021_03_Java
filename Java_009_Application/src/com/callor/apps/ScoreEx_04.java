...
public class ScoreEx_04 {
	...
	public static void main(String[] args) {
		...
		Integer numInt = 30;
		String str2 = numInt.toString(); // .toString() => 숫자를 문자열로 바꿔줌
		str2 = numInt + ""; // 위와 같은 결과나옴
		...
		Integer n1 = Integer.valueOf(str1); // valueOf()는 타입변경 메서드
		...
		System.out.println(Arrays.toString("Republic of Korea".split(" "))); // 문자를 배열로 나누어서 보여주는 형태
		
		// 한번만 쓸때는 그냥 이렇게 쓸때도 있음
