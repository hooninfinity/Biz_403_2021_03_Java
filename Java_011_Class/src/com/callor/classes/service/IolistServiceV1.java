 ...
 * Java에서는 배열을 사용해야 하는 프로젝트에서는 List 클래스를 사용한 객체를 생성하여 진행한다.
 */
public class IolistServiceV1 {
	...
	public void printAllList() {
		...
		for(int i = 0; i < iolist.size(); i++) { // iolist의 개수만큼
