...
import call.callor.app.model.ScoreVO;
import call.callor.app.service.Values;
...
public class ScoreServiceImplV2Ex extends ScoreServiceImplV2 {
	...
	public void inputScore() {
		...
		for(int i = 0 ; i < subjectList.length ; i++) {
			subScoreList[i] = inService.inputValue(subjectList[i]);
	...
	public void saveScore() {
		...
		while(true) {
			...
			strFileName = "src/call/callor/app/" + strFileName + ".txt";
