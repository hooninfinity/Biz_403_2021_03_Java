...
public class App_02 {
	...
	public static void main(String[] args) {
		 ...
		 * 이후에 for() 반복문 등에서 코드를 변경해야 하는 경우를 줄일수있다.
		 */
		int numsLength = 20;
		int intNum = 0;
		
		// int, long, float, double 형 배열을 생성하면
		// 자동으로 모든 배열에 0이 채워지고 clear 된다.
		 ...
		 * 배열 전체를 반복하여 연산을 수행할 때 사용할 수 있는 값
		 */
		 ...
		 * 
		 * for(int num : intNums) 이 코드는 아래의 코드와 같은 연산을 수행한다.
		 * 
		 * for(int i = 0 ; i < intNums.length ; i++) {
		 * 	int num = intNums[i];
		 * }
		...
		/*
		 * intNums 배열중에서 3번요소부터 끝까지 리스트를 출력하라
