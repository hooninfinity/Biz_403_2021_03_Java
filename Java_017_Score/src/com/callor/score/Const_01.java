...
public class Const_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 구현체 클래스의 생성자를 호출하여 객체를 생성, 초기화 해야 한다
		 * 
		 * 인터페이스는 생성자 메서드가 없다.
		 */
		 ...
		 * 각각 ArrayList, LinkedList, Vector type으로 데이터 형이 다르다
		 * 
		 * 하지만 List interface type 으로 선언되었기 때문에
	...
	/*
	 * 매개변수 type 을 List interface type으로 선언한 method
	 * 
	 * 이 method는 List interface의 자손인
	 * 	ArrayList, LinkedList, Vector 클래스로 생성된 객체를
	 * 	매개변수로 받아 연산을 수행할 수 있다
	 * 
