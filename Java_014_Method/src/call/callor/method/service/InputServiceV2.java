 ...
 * inputValue2("새우깡", 0, 1000); // 매개변수 오류(2번은 매개변수 2개짜리인데 3개를 써서)
 * 
...
public class InputServiceV2 {
	 ...
	 * 이미 만들어진 inputValue(String title) method와 연동하여 사용하겠다.
	 */
	...
	public Integer inputValue(String title) {
		...
		while(true) {
			...
			// if조건문이 false일 경우 실행되는 부분
			// 굳이 else를 사용하지 않아도 문제 없는 코드
			
			Integer intNum = null;
			try {
				intNum = Integer.valueOf(strInput); // try문이 정상이면 여기 다음은 return으로 간다
