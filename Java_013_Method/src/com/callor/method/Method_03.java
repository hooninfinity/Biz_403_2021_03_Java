...
public class Method_03 {
	...
	public static void main(String[] args) {
		/*
		 * NumberServiceV1 클래스에 작성한 inputNum()을 호출하여 명령을 수행하고 싶다
		 * 이때 C 와 같은 언어는 단순히 method 이름만 호출하여 명령을 수행할 수 있다
		 * 이런 type을 함수호출(function call)이라고 한다
		 * 
		 * 하지만, 자바는 이러한 함수호출 방식으로 명령을 수행할 수 없다
		 */
		// inputNum();
		 ...
		 * 	3의 배수이면 정수를 아니면 null 값을 return 하도록 되어있다
		 ...
		 * method가 return 하는 값을 받아서 변수에 저장할 수 있다.
		 */
