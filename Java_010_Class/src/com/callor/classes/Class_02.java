...
public class Class_02 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Integer 형(type)의 데이터를 다시 저장(List형 데이터)할 intList 객체를 선언
		 * Integer[] intList = new Integer[??];  (배열에선 ?값을 미리 정해야되는데 그러지 않고 만듬)
		 * 
