...
public class Hello_03 {
	...
	public static void main(String[] args) {
		...
		// java에서는 정수/정수는 몫을 구하기 때문에 결과는 1만 나타난다.
		System.out.println(40 / 30);
		
		// java에서 실수의 표현 1
		// java는 실수를 표현할때 10의 -16승까지 표현한다.
		// 소수점 이하 16자리까지 표현하고 이후 값은 무시 또는 반올림등을 수행한다.
		...
		// 단정도 실수 : 소수이하 7(6)째 자리까지 표현하는 실수
		// 배정도 실수 : 단정도 실수의 2배 이상 자리까지 표현하는 실수
		// 고정소수점 연산(값) : 정수는 소수점 이하 0번째 자리에서 반올림한다.
